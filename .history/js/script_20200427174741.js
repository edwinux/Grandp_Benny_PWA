...
function load_pages(){  
  ...
  for (var i=0;i<num_of_pages;i++){
    ...
    str += '<div class="content is-small" id="content_text"><div class="story_text">' + text + '</div></div></div>';    
...
text_bigger_btn.addEventListener('click', function(){
  var class_list = document.querySelector('.content').classList;
  console.log(class_list);
  //assume only one in any given moment
