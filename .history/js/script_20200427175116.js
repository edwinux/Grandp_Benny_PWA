...
text_bigger_btn.addEventListener('click', function(){
  ...
  if (content.classList[1]==="is-small"){
    content.remove('is-small');
    content.add('is-medium');
  } else if (content.classList[1]==="is-medium"){
    content.remove('is-medium');
    content.add('is-large');
  }
})
...
text_smaller_btn.addEventListener('click', function(){
  ...
  if (content.classList[1]==="is-medium"){
    content.remove('is-medium');
    content.add('is-small');
  } else if (content.classList[1]==="is-large"){
    content.remove('is-large');
    content.add('is-medium');
  }
})
