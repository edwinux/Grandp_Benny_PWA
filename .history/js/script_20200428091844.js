...
function load_pages(book_name,language){  
  ...
  var num_of_pages = storyObj.num_of_pages;
  ...
  for (var i=0;i<num_of_pages;i++){
    if (orientation_is_vertical){    
      var img_src =  "./Images/" + book_name + "/4by3/page3x4_" + i +".jpg";
    } else {
      var img_src = "./Images/" + book_name + "/16by9/page16x9_" + i +".jpg";
    }
    
    var img_alt = "Page " + i + " Image";
    var text    = storyObj.pages[i].text;
  ...
  audioElement = new Audio("./Audio/" + book_name + "/" + language + "/" + storyObj.pages[0].audio);  
  ...
  mySwiper.on('slideChange', function(){
    //If audio of the previous page is still playing - pause it.
      ...
      audioElement = new Audio("./Audio/" + book_name + "/" + language + "/" + storyObj.pages[mySwiper.activeIndex].audio);  
      audioElement.addEventListener('ended', function(){     
        mySwiper.slideNext();
      });
...
window.addEventListener("orientationchange", function(){
  ...
  var num_of_pages = storyObj.pages.length;  
  for (var i=0;i<num_of_pages;i++){
    if (orientation_is_vertical){    
      var img_src =  "./Images/" + book_name + "/4by3/page3x4_" + i +".jpg";
    } else {
