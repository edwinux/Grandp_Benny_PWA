...
window.addEventListener("orientationchange", function(){
  ...
  var orientation_is_vertical = !(window.innerHeight > window.innerWidth); //NOT due to bug
  var num_of_pages = storyObj.story.pages.length;
  ...
  var path_to_audio = storyObj.story.path_to_audio;
  audioElement = new Audio(path_to_audio + storyObj.story.pages[index_of_current_slide].audio);  
  audioElement.addEventListener('ended', function(){     
    mySwiper.slideNext();
  });
